    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type',
                 models.CharField(choices=[('task', 'task'), ('job', 'job')],
                                  max_length=16)),
                ('script', models.CharField(max_length=160)),
                ('script_type',
                 models.CharField(choices=[('ansible', 'ansible'),
                                           ('task_generator', 'task_generator')
                                           ],
                                  max_length=16)),
                ('state_on_success', models.CharField(blank=True,
                                                      max_length=64)),
            ...
            fields=[
                ('id',
                 models.AutoField(auto_created=True,
                                  ...
                                  verbose_name='ID')),
                ('type',
                 models.CharField(choices=[('service', 'service'),
                                           ('cluster', 'cluster'),
                                           ('host', 'host')],
                                  max_length=16)),
                ('name', models.CharField(max_length=160)),
