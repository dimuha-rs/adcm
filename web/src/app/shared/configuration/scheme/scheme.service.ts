...
export class SchemeService {
  ...
  emptyValidator(): () => ValidatorFn {
    ...
    return (): ValidatorFn => {
      return (control: AbstractControl): { [key: string]: any } | null => (isEmptyValue(control.value) ? { isEmpty: true } : null);
    };
  }

  setCurrentForm(type: matchType, parent: FormGroup, field: FieldOptions): AbstractControl {
